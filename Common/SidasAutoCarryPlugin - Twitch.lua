...
class 'Plugin' -- {
	...
	function Plugin:__init() 
		...
		combo:AddCustomCast(_E, function(Target) 
				...
				return enemy and enemy.posion.count == Menu.expunge
			end)
	...
	Menu = AutoCarry.Plugins:RegisterPlugin(Plugin(), "Twitch") 
	Menu:addParam("expunge", "Expunge amount",SCRIPT_PARAM_SLICE, 6, 0, 6, 0)
-- }