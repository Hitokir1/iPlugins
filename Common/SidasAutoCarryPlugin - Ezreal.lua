...
class 'Plugin' -- {
	...
	function Plugin:__init() 
		AutoCarry.Crosshair:SetSkillCrosshairRange(2000)
	...
	function Plugin:OnTick() 
		...
		if Target and AutoCarry.Keys.AutoCarry then
			if Menu.eJump and SkillE:Ready() then 
	...
	Menu = AutoCarry.Plugins:RegisterPlugin(Plugin(), "Ezreal") 
	Menu:addParam("eJump", "E to Mouse", SCRIPT_PARAM_ONOFF, true)
-- }